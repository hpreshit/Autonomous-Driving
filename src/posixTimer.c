...
int start_timer(timer_t timer_id , uint64_t time_msec, uint8_t oneshot)
{
	// if(NULL == timer_id)
	// 	return -1;
	...
	ts.it_value.tv_sec = time_msec / MILLISEC;
	ts.it_value.tv_nsec = (time_msec % MILLISEC) * 1000000;
	if(1 == oneshot)
	{
